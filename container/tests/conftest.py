...
def setup_invoice_schema_json():
    invoice_filename = "invoice.schema.json"

    test_specification_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "templates", "template", invoice_filename)
